        ...
        <div className="mx-auto flex max-w-[1600px] flex-wrap items-center justify-between gap-3 px-6 py-4">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h1 className="text-base font-semibold tracking-tight text-foreground">Build annual plan</h1>
                <p className="text-xs text-muted-foreground">Set budget, must-go conferences and shortlist.</p>
              </div>
            </div>
